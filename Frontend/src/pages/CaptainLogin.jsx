...
const CaptainLogin = () => {
  ...
  return (
    <div className='px-5 py-5 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link to='/login' className='bg-[#10b461] flex items-center justify-center mb-5 text-base text-white font-semibold w-full px-4 py-2 rounded'>Sign in as User</Link>
      </div>
